...
export default function CategoryBanner() {
  return (
    <section className="relative flex flex-col justify-center w-[calc(100% - 256px)] h-[378px] mx-32 bg-category-banner bg-cover bg-no-repeat bg-center rounded-[20px]">
      <div className="absolute right-24 flex flex-col items-end max-w-1/3 text-right">
        <h1 className="pb-1 text-[52px] font-extrabold text-neutral">
          One more friend
        </h1>
        <h2 className="pb-2 text-4xl font-bold text-neutral">
          Thousands more fun!
        </h2>
        <p className="pb-6 text-xs font-medium text-neutral-20">
